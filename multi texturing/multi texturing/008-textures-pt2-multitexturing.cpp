...
namespace opengl4_mbsoftworks {
	namespace tutorial008 {
		...
		{
			{ glm::vec3(-140, 10, 94), glm::radians(90.0f) },
		//	{ glm::vec3(-140, 10, 10), glm::radians(90.0f) },
		...
		void OpenGLWindow008::initializeScene()
		{
			...
			houseTexture.loadTexture2D("data/textures//tut008/R.jpg");
			houseTextureFront.loadTexture2D("data/textures/tut008/R.jpg");
			houseTextureSide.loadTexture2D("data/textures/tut008/R.jpg");
